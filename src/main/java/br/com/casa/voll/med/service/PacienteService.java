...
public class PacienteService {
    ...
    public PacienteResponseDTO atualizarPacientesParcial(Long id, PacienteRequestDTO dto) {
        ...
        if (dto.getEndereco() != null) {paciente.setEndereco(dto.getEndereco().setRua(););}
        if (dto.getEndereco() != null) {paciente.setEndereco(dto.getEndereco().setNumero(););}
        if (dto.getEndereco() != null) {paciente.setEndereco(dto.getEndereco().setComplemento(););}
        if (dto.getEndereco() != null) {paciente.setEndereco(dto.getEndereco().setBairro(););}
        if (dto.getEndereco() != null) {paciente.setEndereco(dto.getEndereco().setCep(););}
        if (dto.getEndereco() != null) {paciente.setEndereco(dto.getEndereco().setCidade(););}
        if (dto.getEndereco() != null) {paciente.setEndereco(dto.getEndereco().setUf(););}
